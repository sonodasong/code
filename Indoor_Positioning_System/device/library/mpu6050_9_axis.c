...
const uint8 dmpMemory[MPU6050_DMP_CODE_SIZE] = {
	// bank 0, 256 bytes
...
const uint8 dmpConfig[MPU6050_DMP_CONFIG_SIZE] = {
...
const uint8 dmpUpdates[MPU6050_DMP_UPDATES_SIZE] = {
...
static OS_EVENT *mpu6050Rdy;

void mpu6050DMPInit(void)
{
	mpu6050IRQInit();
	mpu6050IRQDisable();
	mpu6050Rdy = OSSemCreate(0);
}
